  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{user.fullName.split(" ")[0]}</span>
        ...
        <div>
          ...
          {user.tenant && (
            <span className="mt-0.5 block text-theme-xs text-gray-400 dark:text-gray-500">
              {user.tenant.businessName} &middot; {user.role?.name ?? "Staff"}
            </span>
          )}
        </div>
