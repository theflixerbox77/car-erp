...
export class StorefrontCustomerController {
  ...
  listWishlist(@Req() req: CustomerRequest) {
    return this.customerService.listWishlist(
      req.customerAccount.tenantId,
  ...
  addToWishlist(
    ...
    return this.customerService.addToWishlist(
      req.customerAccount.tenantId,
      req.customerAccount.id,
      vehicleId,
    );
  ...
  removeFromWishlist(
    ...
    return this.customerService.removeFromWishlist(
      req.customerAccount.id,
      vehicleId,
    );
  }
  ...
  listBookings(@Req() req: CustomerRequest) {
    return this.customerService.listBookings(
      req.customerAccount.tenantId,
      req.customerAccount.id,
    );
  }
